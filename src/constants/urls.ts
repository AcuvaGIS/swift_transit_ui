...
export const SUBSCRIBE_URL = "/api/billing/subscribe";
...
// Real-Time Tracking
export const REAL_TIME_TRACKING_URL = "/api/real-time-tracking";
export const START_TRACKING_URL = (userId: string, matatuId: string) => `/api/real-time-tracking/start/${userId}/${matatuId}`;
export const STOP_TRACKING_URL = (userId: string, matatuId: string) => `/api/real-time-tracking/stop/${userId}/${matatuId}`;
